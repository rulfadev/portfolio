            ...
            <div class="col-span-2 flex justify-center items-center">
                <div class="cards dark:text-white sm:space-y-6 w-full">
                    <div
                        ...
                        <p class="tip">Study</p>
                        <p class="second-text m-1 sm:px-0 px-2">Informatics Engineering.</p>
                    </div>
                    <div
                        ...
                        <p class="tip">Passionate</p>
                        <p class="second-text m-1 sm:px-0 px-2">Full Stack Web Development, UI/UX, and Database
                            Analysis.
                        </p>
                    </div>
                    <div
